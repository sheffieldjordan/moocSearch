  ...
  */
  self.search = function(query, maxResults, callback) {
    ...
    if (validate !== null) {
      ...
      self.addParam('videoCategoryId', '27');
      self.addParam('relevanceLanguage', 'en');
...
self.khanSearch = function(query, maxResults, callback) {
    var validate = self.validate();
    ...
    if (validate !== null) {
      ...
      self.addParam('part', self.getParts());
      self.addParam('channelId', 'UC4a-Gbdw7vOaccHmFo40b9g');
      self.addParam('type', 'video');
      self.addParam('videoCategoryId', '27');
      self.addParam('q', query);
      self.addParam('maxResults', maxResults);
